...
contract Kingdom is
  ...
  ThroneRulesMixin {
    ...
    function claimThroneRP(
        ...
        monarchsByNumber.push(Monarch(_compensationAddress,_monarchName,now,priceWei,0));
...
contract World is
  ...
  ThroneRulesMixin {
    ...
    function createKingdomRP(
        ...
        kingdomsByNumber.push(KingdomListing(newKingdomNumber,_kingdomName, kingdomContract, msg.sender, now, kingdomFactory));
    }
