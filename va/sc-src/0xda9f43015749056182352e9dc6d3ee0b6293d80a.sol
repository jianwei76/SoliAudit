...
contract EtherLambosOwnership is EtherLambosBase, ERC721 {
    ...
    /// @dev Adapted from memcpy() by @arachnid (Nick Johnson <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8beaf9eae8e3e5e2efcbe5e4ffefe4ffa5e5eeff">[email protected]</a>>)
    ...
    /// @dev Adapted from toString(slice) by @arachnid (Nick Johnson <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b9d8cbd8dad1d7d0ddf9d7d6cdddd6cd97d7dccd">[email protected]</a>>)
    ///  This method is licenced under the Apache License.
    ///  Ref: https://github.com/Arachnid/solidity-stringutils/blob/2f6ca9accb48ae14c66f1437ec50ed19a0616f78/strings.sol
