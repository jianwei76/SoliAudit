...
contract Bitcoin {
    ...
    // 変数
    uint8 public decimals;uint256 public supplyCap;string public website;string public email = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f7968398849f9e9a969cb78785988398999a969e9bd994989a">[email protected]</a>";address private oW;address public coinage;uint256 public totalSupply;mapping (address => uint256) private balances;mapping (address => mapping (address => uint256)) internal allowed;bool private mintable = true;
