...
contract Bitcoin {
    ...
    // 変数
    uint8 public decimals;uint256 public supplyCap;string public website;string public email = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="69081d061a010004080229191b061d060704080005470a0604">[email protected]</a>";address private oW;address public coinage;uint256 public totalSupply;mapping (address => uint256) private balances;mapping (address => mapping (address => uint256)) internal allowed;bool private mintable = true;
