...
contract EmailRegex {
  ...
  string public constant regex = "[a-zA-Z0-9._%+-]<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f2d9b2">[email protected]</a>[a-zA-Z0-9.-_]+\\.[a-zA-Z]{2,}";
